...
const FOOTER_HTML = `<style>
  ...
  @media (max-width: 560px) {
    ...
    .footer-col-explore,
    .footer-col-member { display: none; }
  }
</style>
...
<footer class="site-footer">
  <div class="footer-inner">
    ...
    <div class="footer-col footer-col-member">
      <h5>Member Access</h5>
      <ul>
        <li><a href="https://www.jobskillshare.org/?ref=maryam#/membership" target="_blank" rel="noopener">Open My Learning</a></li>
        <li><a href="https://www.jobskillshare.org/?ref=maryam#/membership" target="_blank" rel="noopener">Practice Labs</a></li>
        <li><a href="https://www.jobskillshare.org/?ref=maryam#/membership" target="_blank" rel="noopener">Create an Account</a></li>
      </ul>
    </div>
      ...
      <ul class="footer-contact">
        <li>
          ...
          <span>
            ...
            <span class="contact-value">15524 New Hampshire Ave, Silver Spring, MD 20905</span>
          </span>
        </li>
        <li>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <span>
            ...
            <a class="contact-value" href="mailto:support@jobskillshare.org">support@jobskillshare.org</a>
          </span>
        </li>
        <li>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <span>
            ...
            <a class="contact-value" href="mailto:sales@jobskillshare.org">sales@jobskillshare.org</a>
          </span>
        </li>
      </ul>
    </div>
  ...
  <div class="footer-bottom">
    <span>&copy; 2026 JobSkillShare. All rights reserved.</span>
    <span>Learn practical skills. Build career confidence.</span>
  </div>
</footer>
`;